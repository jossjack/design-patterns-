 ...
 * @author joseph
 * 
 *         La clase que realiza el proceso en el constructor lee el archivo
 *         desde el disco. En esta clase simulamos en el método loadFromDisk el
 *         trabajo de leer el archivo.
 */
